...
* **Gaps/missing values noticed:** \[`operator`....; `religion`/`denomination` missing on most points"]
...
* **Gaps/missing values noticed:** \["most features are `building=yes` with no specific subtype; addr fields largely empty"]
